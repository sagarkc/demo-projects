...
namespace com.gs.text4net.common.types
{
    /** 
    <summary>
        Represents a Set.
...
# region Overrides
        ...
        */
        ...
        {
            return ((rhs.GetType() == typeof(com.gs.text4net.common.types.Set<T>)) && (this == (Set<T>)rhs));
        }
        ...
        */
        ...
        )
        {
            ...
            ("ToString", com.gs.text4net.common.lib.LibSys.GetTypes(FormatInfo));
