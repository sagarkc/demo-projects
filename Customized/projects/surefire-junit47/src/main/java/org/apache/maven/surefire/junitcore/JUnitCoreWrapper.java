...
class JUnitCoreWrapper
{
        ...
        throws TestSetFailedException
    {
        Computer computer =  //new ParallelComputer(true, true);
        		getComputer( jUnitCoreParameters );
        ...
        throws TestSetFailedException
    {
        ...
        {
        	if(jUnitCoreParameters.isParallelBoth())
        		return new ParallelComputer(true, true);//ConfigurableParallelComputer();
        	else if(jUnitCoreParameters.isParallelClasses() || jUnitCoreParameters.isParallelMethod()){
