 ...
 * @author SG1736
 */
public class SecureSplitPanel extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    private void initComponents() {
        ...
        sizeOrPartTextField = new javax.swing.JTextField();
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        splitterPanel.add(sizeOrPartTextField, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
        splitterPanel.add(sizeComboBox, gridBagConstraints);
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == browseSplitterSourceButton) {
                SecureSplitPanel.this.browseSplitterSourceButtonActionPerformed(evt);
            }
            else if (evt.getSource() == browseSplitterTargetButton) {
                SecureSplitPanel.this.browseSplitterTargetButtonActionPerformed(evt);
            }
            else if (evt.getSource() == splitterStopButton) {
                SecureSplitPanel.this.splitterStopButtonActionPerformed(evt);
            }
            else if (evt.getSource() == splitterStartButton) {
                SecureSplitPanel.this.splitterStartButtonActionPerformed(evt);
            }
            else if (evt.getSource() == sizeRadioButton) {
                SecureSplitPanel.this.sizeRadioButtonActionPerformed(evt);
            }
            else if (evt.getSource() == partsRadioButton) {
                SecureSplitPanel.this.partsRadioButtonActionPerformed(evt);
            }
        }
    ...
    private javax.swing.JTextField sizeOrPartTextField;
