...
public class DirectoryTree extends JTree implements ToolsCommonConstants {

    private final ImageIcon ICON_COMPUTER = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "My_PC.png"));
    private final ImageIcon ICON_DISK = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "CD-DVD_Drive.png"));
    private final ImageIcon ICON_FOLDER_CLOSED = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "icon_folder_closed_16.png"));
    private final ImageIcon ICON_FOLDER_OPENED = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "Folder_open.gif"));
    private final ImageIcon ICON_EXPAND = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "collapse_all.gif"));
    private final ImageIcon ICON_COLLASPE = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "collapse_all.gif"));
    private final ImageIcon NOTEPAD_ICON = new ImageIcon(
            DirectoryTree.class.getResource(DirectoryTree_IMAGE_PATH + "file_icon.gif"));
