...
public class WindowUtil {
     ...
     * @param components
     */
    public static void enableComponents(final boolean enable, final Component... components) {
        if (null == components) {
            return;
        }
     ...
     * @param components
     */
    public static void enableAllComponentsExcept(final boolean enable, final Frame parent, final Component... components) {
        if (null != parent) {
    ...
    public static void visibleComponents(final boolean visible, final Component... components) {
        if (null == components) {
            return;
        }
        if (components.length <= 0) {
    ...
    public static void visibleAllComponents(final boolean visible, final Frame parent) {
        if (null != parent) {
            Component[] components = parent.getComponents();
            if (null == components) {
                return;
    ...
    public static void visibleAllComponentsExcept(final boolean visible, final Frame parent, final Component... components) {
        if (null != parent) {
            Component[] allComponents = parent.getComponents();
            if (null == allComponents) {
                return;
