 ...
 *  ---------------------------------------------------------------------------* 
 * Type     : com.gs.utils.swing.ScrollablePanel
 * Date     : May 28, 2013
 */
...
public class ScrollablePanel extends JPanel
    ...
    public interface ScrollableSizeHint {
        int NONE = 19001;
        int FIT = 19002;
        int STRETCH = 19003;
    }

    public interface IncrementType {

        int PERCENT = 9001;
        int PIXELS = 9002;
    }
    private int scrollableHeight = ScrollableSizeHint.NONE;
    private int scrollableWidth = ScrollableSizeHint.NONE;
     ...
     */
    public void setScrollableWidth(int scrollableWidth) {
     ...
     *      scrollable amount
     */
    public void setScrollableBlockIncrement(int orientation, int type, int amount) {
     ...
     *                 scrollable amount
     */
    public void setScrollableUnitIncrement(int orientation, int type, int amount) {
        IncrementInfo info = new IncrementInfo(type, amount);
...
//  Implement Scrollable interface
    ...
    static class IncrementInfo {
        ...
        public IncrementInfo(int type, int amount) {
            this.type = type;
            this.amount = amount;
        }
