 ...
 * -------------------------------------------------------------------------- *
 * Type:	com.xchanging.etl.mgr.web.client.service.rt.RTSelectedJobMonitorPushServiceAsync
 * Date:	Aug 22, 2013  5:33:46 PM
 * 
 * -------------------------------------------------------------------------- *
 */
 ...
 *
 */
public interface RTSelectedJobMonitorPushServiceAsync {
