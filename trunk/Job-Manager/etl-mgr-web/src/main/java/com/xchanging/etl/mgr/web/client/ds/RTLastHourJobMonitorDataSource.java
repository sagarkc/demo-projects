 ...
 *
 */
public class RTLastHourJobMonitorDataSource extends RealTimeJobExecutionDataSource {
	private static RTLastHourJobMonitorDataSource instance = null;  
    ...
    public static RTLastHourJobMonitorDataSource getInstance() {  
        if (instance == null) {  
            instance = new RTLastHourJobMonitorDataSource("RTLastHourJobMonitorDataSource");  
        }  
        return instance;  
    }  
	/**
	 * 
	 */
	private RTLastHourJobMonitorDataSource(String id) {
		super(id);
	}
	...
	protected void executeFetch(final String requestId, DSRequest request,
		...
		monitorService.loadRTLastHourJobMonitorData(new AsyncCallback<List<JobExecutionHistoryVo>>() {
