 ...
 * -------------------------------------------------------------------------- *
 * Type:	com.xchanging.etl.mgr.web.client.service.rt.RTLastDayJobMonitorPushServiceAsync
 * Date:	Aug 22, 2013  5:33:27 PM
 * 
 * -------------------------------------------------------------------------- *
 */
 ...
 *
 */
public interface RTLastDayJobMonitorPushServiceAsync {
