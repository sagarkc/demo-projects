 ...
 *
 */
public class JSONDataSourceGridDataModel<T extends JavaScriptObject> implements GWTCollectionGridModel<T> {
	...
	public JSONDataSourceGridDataModel(List<GWTGridColumnHeader> columnHeaders) {
	...
	public JSONDataSourceGridDataModel(List<T> jsonDataObjects, List<GWTGridColumnHeader> columnHeaders) {
