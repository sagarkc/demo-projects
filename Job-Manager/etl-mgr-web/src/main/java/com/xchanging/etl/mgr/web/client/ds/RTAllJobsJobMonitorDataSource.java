 ...
 * -------------------------------------------------------------------------- *
 * Type:	com.xchanging.etl.mgr.web.client.ds.RTAllJobsJobMonitorDataSource
 * Date:	Aug 22, 2013  6:42:44 PM
 * 
 * -------------------------------------------------------------------------- *
 */
 ...
 *
 */
public class RTAllJobsJobMonitorDataSource extends RealTimeJobExecutionDataSource {
	private static RTAllJobsJobMonitorDataSource instance = null;  
    ...
    public static RTAllJobsJobMonitorDataSource getInstance() {  
        if (instance == null) {  
            instance = new RTAllJobsJobMonitorDataSource("RTAllJobsJobMonitorDataSource");  
        }  
        return instance;  
    }  
	/**
	 * 
	 */
	private RTAllJobsJobMonitorDataSource(String id) {
		super(id);
	}
	...
	protected void executeFetch(final String requestId, DSRequest request,
		...
		monitorService.loadRTAllJobsJobMonitorData(new AsyncCallback<List<JobExecutionHistoryVo>>() {
