 ...
 * -------------------------------------------------------------------------- *
 * Type:	com.xchanging.etl.mgr.web.client.service.rt.RTFilteredJobMonitorPushServiceAsync
 * Date:	Aug 22, 2013  5:33:15 PM
 * 
 * -------------------------------------------------------------------------- *
 */
 ...
 *
 */
public interface RTFilteredJobMonitorPushServiceAsync {
