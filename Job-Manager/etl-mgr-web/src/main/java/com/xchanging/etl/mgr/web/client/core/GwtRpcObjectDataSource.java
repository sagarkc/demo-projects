 ...
 * -------------------------------------------------------------------------- *
 * Type:	com.xchanging.etl.mgr.web.client.core.GwtRpcObjectDataSource
 * Date:	Aug 2, 2013  8:10:42 PM
 * 
 * -------------------------------------------------------------------------- *
 */
 ...
 * 
 */
public abstract class GwtRpcObjectDataSource extends DataSource {
