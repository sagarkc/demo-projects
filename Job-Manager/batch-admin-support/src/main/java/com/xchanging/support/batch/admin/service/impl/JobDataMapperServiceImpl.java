 ...
 * 
 */
package com.xchanging.support.batch.admin.service.impl;
...
import com.xchanging.support.batch.admin.model.BatchJobDetail;
		...
		try {
			...
			for (String groupName : groupNames) {
				...
				for (String jobDetailName : jobDetailNames) {
					...
					batchJobDetail.setJobGroupName(groupName);
