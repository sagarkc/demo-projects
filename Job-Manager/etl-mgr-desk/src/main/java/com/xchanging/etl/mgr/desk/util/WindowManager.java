...
public final class WindowManager implements InternalFrameListener {
    ...
    public static final String SECURE_SPLIT_WINDOW_TITLE = "Secure Split";
    public static final String SECURE_JOIN_WINDOW_TITLE = "Secure Join";
    public static final String FLAT_SPLIT_WINDOW_TITLE = "Flat Split";
    public static final String FLAT_JOIN_WINDOW_TITLE = "Flat Join";
    public static final String TEXT_SPLIT_WINDOW_TITLE = "Text Split";
    public static final String TEXT_JOIN_WINDOW_TITLE = "Text Join";
    public static final String PDF_SPLIT_WINDOW_TITLE = "PDF Split";
    public static final String PDF_JOIN_WINDOW_TITLE = "PDF Join";
    public static final String XML_SPLIT_WINDOW_TITLE = "XML Split";
    public static final String XML_JOIN_WINDOW_TITLE = "XML Join";
    
    public static final String SHOW_LOG_WINDOW_TITLE = "Show Log";
    public static final String APP_SETTINGS_WINDOW_TITLE = "Settings";
    
    public static final String SHOW_HELP_WINDOW_TITLE = "Help";
    
    public static final int FRAME_DISTANCE = 10;
    public static final int FRAME_X = 10;
    public static final int FRAME_Y = 10;
