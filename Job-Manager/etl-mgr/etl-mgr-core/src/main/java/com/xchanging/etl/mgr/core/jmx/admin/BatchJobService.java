 ...
 * -------------------------------------------------------------------------- *
 * Type:	com.xchanging.etl.mgr.core.jmx.admin.BatchJobService
 * Date:	Oct 8, 2013  5:16:32 PM
 * 
 * -------------------------------------------------------------------------- *
 */
 ...
 *
 */
public class BatchJobService implements JobService, DisposableBean {

	private static final Log logger = LogFactory.getLog(BatchJobService.class);
